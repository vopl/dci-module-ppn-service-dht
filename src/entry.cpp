    ...
    namespace
    {
            ...
            : public dci::host::module::Manifest
        {
            Manifest()
            {
                ...
                pushServiceId<idl::ppn::service::Dht>();
            }
        } manifest_;
            ...
            : public dci::host::module::Entry
        {
            ...
            {
                if(auto s = tryCreateService<Dht>(ilid)) return cmt::readyFuture(s);
...
extern "C"
{
    DCI_INTEGRATION_APIDECL_EXPORT dci::host::module::Entry* dciModuleEntry = &dci::module::ppn::service::dht::entry_;
}
